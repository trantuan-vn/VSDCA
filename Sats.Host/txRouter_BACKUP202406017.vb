                    ...
                    If v_ds.Tables(0).Rows.Count > 0 Then
                        ...
                        Else
                            ...
                            If Not ServerBussinessCA.DecryptTrade_HNX(v_strAppPath & "data\" & v_Prefix & "_TRADING_RESULT" & _
                                                                      IIf(v_strBRID = "0008", v_strCurrDateTPRL, v_strTxdate1), _
                                                                      v_Prefix & "_TRADING_RESULT" & IIf(v_strBRID = "0008", v_strCurrDateTPRL, v_strTxdate1)) Then
                                Return -1
                                Exit Function

                            End If
                            If File.Exists(v_strAppPath & "data\" & v_Prefix & "_TRADING_RESULT" & IIf(v_strBRID = "0008", v_strCurrDateTPRL, v_strTxdate1) & ".zip") Then
                                Dim mv_xzipEngine As New ZipEngine
                                mv_xzipEngine.UnzipFile(v_strAppPath & "data", v_Prefix & "_TRADING_RESULT" & IIf(v_strBRID = "0008", v_strCurrDateTPRL, v_strTxdate1) & ".zip", _
                                                        v_Prefix & "_TRADING_RESULT" & IIf(v_strBRID = "0008", v_strCurrDateTPRL, v_strTxdate1) & ".xml")
                                Dim f As New IO.FileInfo(v_strAppPath & "data\" & v_strBRID & "_" & IIf(v_strBRID = "0008", v_strCurrDateTPRL, v_strTxdate1) & ".xml")
                                If f.Exists Then
                                    f.Delete()
                                End If
                                Rename(v_strAppPath & "data\" & v_Prefix & "_TRADING_RESULT" & IIf(v_strBRID = "0008", v_strCurrDateTPRL, v_strTxdate1) & ".xml", _
                                        v_strAppPath & "data\" & v_strBRID & "_" & IIf(v_strBRID = "0008", v_strCurrDateTPRL, v_strTxdate1) & ".xml")
...
#Region " Private methods "
    ...
    Public Function CheckHOST(ByRef pv_oNode As Xml.XmlNode, ByRef pv_oXml As XmlDocumentEx, Optional ByVal mv_oSignServer As SignServer = Nothing) As Long
        ...
        Try
            ...
            If InStr("1127|1128|1122|1116|1111|1110|1109|4003|4004|4005|4006|4007|4020|3079|2133|2136|2139|2142|2145|2148|2163|2166|2169|2172|4109|1113", v_strPARENT_TLTXCD) > 0 And v_strPARENT_TLTXCD <> "" Then
        ...
        Try
            ...
            With pv_oNode
                ...
                Else
                    ...
                    v_oWriter.WriteLine("get " & v_Prefix & IIf(v_strBRID = "0008", "_Trading_Result", "_TRADING_RESULT") & IIf(v_strBRID = "0008", v_strCurrDateTPRL, v_strTxdate1) & ".zip " & v_Prefix & "_TRADING_RESULT" & IIf(v_strBRID = "0008", v_strCurrDateTPRL, v_strTxdate1) & ".zip")
                    ...
                    'Exit Function
                    'End If
                    If Not File.Exists(v_strAppPath & "tmp\" & v_Prefix & IIf(v_strBRID = "0008", "_Trading_Result", "_TRADING_RESULT") & IIf(v_strBRID = "0008", v_strCurrDateTPRL, v_strTxdate1) & ".zip") Then
                        v_intErrCount = 1
                        v_strErrMsg = "Chưa có file kết quả giao dịch"
                        'Exit Function
                    Else
                        v_intErrCount = 0
                        File.Delete(v_strAppPath & "tmp\" & v_Prefix & IIf(v_strBRID = "0008", "_Trading_Result", "_TRADING_RESULT") & IIf(v_strBRID = "0008", v_strCurrDateTPRL, v_strTxdate1) & ".zip")
                        Return True
                    End If
                End If
                'End If
