...
#Region "Cac ham, thu tuc khac"
    ...
    Private Sub FormatNumericTextbox(ByVal pv_ctrl As TextBox)
        Try
            ...
            'HungDT 04/06/2024: Rao doan code nay do Brid=0008 su dung cho TPRL nen khong ap dung rules nay
            ...
            If mv_strCOTLTXCD <> "" Then
                ...
                Select Case v_strTLTXCD
                    ...
                    Case "4004"
                        ...
                        '        Return False
                        '    End If
                    Case "2133", "2136", "2139", "2142", "2145", "2163", "2166", "2169", "2172", "2148", "4109"
                    Case Else
