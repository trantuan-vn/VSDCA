...
#Region "Private Function"
    ...
    Private Sub InitReport()
        ...
        mv_rptGroupH.RepeatStyle = RepeatStyle.OnPageIncludeNoDetail
    ...
    Private Sub InitHeader()
        Try
            ...
            If mv_strIsSignCA = "1" Then
                rtf.ReplaceField("SIGNCA", "* Thông báo/báo cáo đã được ký xác nhận bằng chữ ký số của người có thẩm quyền của VSDC")
                rtf.ReplaceField("SIGNCA1", "")
            Else
                rtf.ReplaceField("SIGNCA", " ")
                rtf.ReplaceField("SIGNCA1", " ")
