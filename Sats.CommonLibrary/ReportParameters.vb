...
#Region " Declaration "
    ...
    Private mv_strStoreID As String
    Private mv_strParamValue As String
    Private mv_intCols As Integer
    Private mv_intColOrd As Integer
...
#Region " Properties "
    ...
    Public Property ParamValue() As String
        Get
            Return mv_strParamValue
        End Get
        Set(ByVal value As String)
            mv_strParamValue = value
        End Set
    End Property
